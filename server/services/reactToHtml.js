// Server-side React-to-HTML converter for email templates
// This generates the HTML directly without needing React components

function generateUnpaidEmailHtml(quizData, userEmail) {
  // Generate personalized snapshot based on quiz data
        ...
        <div style="margin-bottom: 32px; border-radius: 16px; border: none; box-shadow: 0 8px 32px rgba(30, 41, 59, 0.18); padding: 40px 40px 24px 40px; background: #f1f5f9; text-align: left; position: relative; min-height: 140px;">
          <div style="display: flex; align-items: flex-start; justify-content: space-between; margin-bottom: 14px;">
            <div style="display: flex; align-items: center; gap: 18px;">
              <span style="font-size: 38px; margin-right: 8px;">💡</span>
              <h3 style="font-size: 27px; font-weight: 900; color: #18181b; margin: 0; letter-spacing: -0.01em; line-height: 1.1;">Online Reselling</h3>
            </div>
            <div style="text-align: center; margin-left: 18px;">
              <div style="font-weight: 900; font-size: 32px; color: #6366f1; line-height: 1;">92%</div>
          ...
          <div style="margin-bottom: 16px;">
            ...
            <ul style="color: #334155; font-size: 15px; margin: 0; padding: 0 0 0 18px; line-height: 1.7; list-style: disc;">
              <li style="margin-bottom: 6px;">Low startup costs</li>
              <li style="margin-bottom: 6px;">Flexible work schedule</li>
              <li style="margin-bottom: 6px;">Scalable business model</li>
            </ul>
          </div>
          <p style="color: #18181b; font-size: 16px; margin-bottom: 24px; line-height: 1.7;">Perfect for entrepreneurs who want to start with minimal investment and scale up based on market demand.</p>
        </div>
...
function generatePaidEmailHtml(quizData, userEmail) {
  // Generate personalized snapshot based on quiz data
  const snapshotLines = getPersonalizedSnapshot(quizData);
    ...
    <div style="max-width: 700px; margin: 40px auto 0 auto; border-radius: 24px; box-shadow: 0 8px 32px rgba(37, 99, 235, 0.10); background: #fff; overflow: hidden;">
      ...
      <div style="padding: 40px 32px 32px 32px; background: #fff; border-bottom-left-radius: 0; border-bottom-right-radius: 0;">
        ...
        <div style="text-align: center; margin: 0 0 32px 0;">
          <a href="https://bizmodelai.com/results" style="display: inline-block; background: linear-gradient(90deg, #2563eb 0%, #7c3aed 100%); color: #fff; padding: 16px 40px; border-radius: 999px; font-weight: 900; font-size: 20px; text-decoration: none; box-shadow: 0 6px 24px rgba(59,130,246,0.13); letter-spacing: -0.01em; margin-top: 0;">View Full Results</a>
        </div>
      </div>
    </div>
